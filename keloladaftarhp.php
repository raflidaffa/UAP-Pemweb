    ...
    <div class="wrapper" id="wrapper">
        ...
        <div class="content" id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <a href="tambahhp.php" class="btn btn-success mb-3">TAMBAH HP BARU</a>
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<td>
                                            <a href="edit_hp.php?id=' . $row["id_hp"] . '" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="delete_hp.php?id=' . $row["id_hp"] . '" class="btn btn-danger btn-sm">Delete</a>
                                          </td>';
                                    echo "</tr>";
                                }
                            } else {
