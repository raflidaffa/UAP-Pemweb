...
<head>
    ...
    <title>Admin - Kelola Daftar HP</title>
    ...
    <div class="wrapper" id="wrapper">
        ...
        <div class="sidebar border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="kelolapengguna.php" class="list-group-item list-group-item-action bg-primary text-white active">Pengguna</a>
        ...
        <div class="content" id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h2>Daftar Akun</h2>
                <a href="tambahakun.php" class="btn btn-success mb-3">TAMBAH AKUN</a>
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>" . $row["role"] . "</td>";
                                    echo '<td>
                                            <a href="editakun.php?id=' . $row["id_akun"] . '" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="hapusakun-exe.php?id=' . $row["id_akun"] . '" class="btn btn-danger btn-sm">Delete</a>
                                          </td>';
                                    echo "</tr>";
                                }
                            } else {
